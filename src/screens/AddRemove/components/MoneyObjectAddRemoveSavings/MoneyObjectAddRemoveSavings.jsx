...
export const MoneyObjectAddRemoveSavings = ({ comprar = false, ...elem }) => {
  ...
  return (
    <View
      ...
      <View style={{ marginRight: 15 }}>
        <ItemMoney {...elem} />
        {comprar ? <Text>{`TENES ${restante} EN TUS AHORROS`}</Text> : null}
      </View>
      <View>
        <View>
          <Text
        ...
        <View
          ...
          <TouchableOpacity
            disabled={
              comprar ? restante === 0 || elem.totalMoneySavings <= 0 : false
            }
            onPress={() => {
              add();
              elem.handleAdd();
            ...
            <AntDesign
              ...
              color={
                comprar
                  ? restante === 0 || elem.totalMoneySavings <= 0
                    ? 'grey'
                    : 'green'
                  : 'green'
              }
